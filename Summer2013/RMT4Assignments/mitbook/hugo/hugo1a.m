%hugo1a.m  modified version
% of hugo.m, to compute graph for green10.tex
...
nt=52;                % number of periods to compute
for i=1:3             % i: ith initial promise value
for t=1:nt            % t: tth period
...
%plot(rep(1,:))
%figure(2)
ymin=0;ymax=.9;xmin=0;xmax=52;
v=[xmin xmax ymin ymax];
hold on
axis(v)
plot(rep(2,:))
hold off
print -deps hugorepl.ps 
diary off
